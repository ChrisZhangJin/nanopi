...
status: unknown
last_updated: "2026-09-07T13:41:47.086Z"
last_activity: "2026-09-07 — plugin outbound surface stage 3: `host-call-tool` behind a per-tool `allow_tools` grant, one execution path with an origin flag, and the `/tools` grant row the earlier stages deferred."
---
