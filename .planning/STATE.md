...
last_activity: "2026-09-07 — plugin outbound surface stages 1 and 2: a keyed store, attributed rate-limited output, and context contribution injected per turn. All carried as imports, so the lock model and observe-only are untouched."
---
