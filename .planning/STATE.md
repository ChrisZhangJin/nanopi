...
last_activity: "2026-09-07 — plugins gained an outbound surface (stage 1 of docs/plugin-capabilities.md): a keyed store, and attributed rate-limited output. Carried as imports, so the lock model and observe-only are untouched."
---
